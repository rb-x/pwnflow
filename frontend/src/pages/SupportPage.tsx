...
// Official Buy Me a Coffee Icon
const BuyMeACoffeeIcon = React.memo(() => (
  <svg
    className="h-5 w-5"
            ...
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription>
                    Help us keep the lights on and build more features
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid gap-3">
                <Button
                  onClick={() =>
                    handleExternalLink(
                      "https://www.paypal.com/paypalme/hacktoolsEXT"
                    )
                  }
                ...
                >
                  <PayPalIcon />
                  <span className="ml-2">Support via PayPal</span>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="grid gap-3">
                <Button
                  onClick={() =>
                    handleExternalLink("https://discord.gg/hVw33XrRhY")
                  }
                  className="w-full h-12 text-base font-medium"
                  variant="outline"
                >
                  <MessageCircle className="h-5 w-5" />
                  <span className="ml-2">Join Discord Community</span>
                  <ExternalLink className="ml-auto h-4 w-4" />
                </Button>

                <Button
                  onClick={() =>
                    handleExternalLink("mailto:support@penflow.sh")
                  }
                  className="w-full h-12 text-base font-medium"
                  variant="outline"
                >
              ...
              <div className="text-sm text-muted-foreground">
                <p>Get help and connect with others:</p>
                <ul className="list-disc list-inside mt-2 space-y-1">
